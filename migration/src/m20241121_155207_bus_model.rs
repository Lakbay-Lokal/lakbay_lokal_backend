...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let table = Table::create()
            ...
            .col(
                ColumnDef::new(Bus::LocationLongitude)
                    .double()
                    .not_null()
            )
            .col(
                ColumnDef::new(Bus::LocationLatitude)
                    .double()
                    .not_null()
            )
            .col(
            ...
            .col(
                ColumnDef::new(Bus::RouteId)
                    .integer()
                    .not_null()
            )
            .col(
                ColumnDef::new(Bus::NextStationId)
                    .integer()
                    .not_null()
            )
            .col(
                ColumnDef::new(Bus::AssignedDriver)
                    .integer()
                    .not_null()
            )
            .foreign_key(
